...
import { getGetApiV1UsersMeQueryKey, usePostApiV1AuthLogout } from "@storyecho/api-client";
    ...
    return (
      <SettingsSection title="계정">
        <div className="space-y-3 p-4">
          ...
          <Button className="w-full rounded-full" onClick={() => router.push("/settings/signup")}>
            회원가입
          </Button>
        </div>
      </SettingsSection>
  ...
  return (
    <>
      <SettingsSection title="계정">
        ...
        <SettingsRow label="회원탈퇴" destructive onClick={() => setShowDeleteDialog(true)} />
      </SettingsSection>
