...
export function DrawerSearchBar({ query, onQueryChange }: DrawerSearchBarProps) {
  return (
    <div className="bg-canvas/95 sticky top-0 z-10 mb-6 py-2 backdrop-blur-sm">
      <label className="border-hairline-strong relative flex items-center rounded-full border bg-white px-4 py-2.5 shadow-sm">
