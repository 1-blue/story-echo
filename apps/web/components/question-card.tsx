...
export function QuestionExploreLinks() {
  return (
    <section aria-labelledby="question-explore-heading" className="flex w-full flex-col gap-3">
      <h2
        id="question-explore-heading"
        className="text-center text-xs font-medium tracking-wide text-stone uppercase"
      >
        더 알아보기
      </h2>
      <Button
        asChild
        variant="outline"
        className="h-auto w-full rounded-full border-hairline-strong bg-white py-3 text-sm text-charcoal hover:bg-surface-cream active:scale-[0.98]"
      >
